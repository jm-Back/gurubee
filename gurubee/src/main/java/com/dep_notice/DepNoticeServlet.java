...
@MultipartConfig
@WebServlet("/dep_notice/*")
public class DepNoticeServlet extends MyUploadServlet {
	// 부서 공지사항 게시판 서블릿
	...
	protected void execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		*/
		...
		pathname = root + "uploads" + File.separator + "dep_notice";
	...
	protected void list(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			List<DepNoticeDTO> list = null;
			
			// 검색 안 할시
			if(keyword.length() == 0) {
				list = dao.listBoard(offset, size, info.getDep_name());
			} else { // 검색시
				list = dao.listBoard(offset, size, condition, keyword, info.getDep_name());
			}
			
			// 공지글
			List<DepNoticeDTO> listNotice = null;
			listNotice = dao.listNotice(info.getDep_name());
			for (DepNoticeDTO dto : listNotice) {
			...
			// 페이징
			String listUrl = cp + "/dep_notice/list.do";
			String articleUrl = cp + "/dep_notice/article.do?page="+current_page;
			...
			req.setAttribute("dep_name", info.getDep_name());
		...
		String path = "/WEB-INF/views/dep_notice/list.jsp";
	...
	protected void writeForm(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String path = "/WEB-INF/views/dep_notice/write.jsp";
		forward(req, resp, path);
	}
	...
	protected void writeSubmit(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String cp = req.getContextPath();
		if(req.getMethod().equalsIgnoreCase("GET")) {
			resp.sendRedirect(cp + "/dep_notice/list.do");
			return;
		}
		...
		try {
			...
			dto.setPos_name(info.getPos_name());
			dto.setDep_name(info.getDep_name());
	...
	protected void article(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			// 게시물 가져오기
			DepNoticeDTO dto = dao.readBoard(num);
			
			if(dto == null) {
				resp.sendRedirect(cp + "/dep_notice/list.do?" + query);
				return;
			}
			...
			forward(req, resp, "/WEB-INF/views/dep_notice/article.jsp");
			return;
	...
	protected void updateForm(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			forward(req, resp, "/WEB-INF/views/dep_notice/write.jsp");
			return;
	...
	protected void updateSubmit(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.sendRedirect(cp + "/dep_notice/list.do?page=" + page);
	...
	protected void listReply(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			forward(req, resp, "/WEB-INF/views/dep_notice/listReply.jsp");
			return;
	...
	protected void listReplyAnswer(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			forward(req, resp, "/WEB-INF/views/dep_notice/listReplyAnswer.jsp");
			return;
