...
<main>
	<div class="container">
					...
					<div class="col-6 text-center">
						<form class="row" name="searchForm" action="${pageContext.request.contextPath}/dep_notice/list.do" method="post">
							<div class="search">
								...
								<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/dep_notice/list.do';"><i class="fa-solid fa-repeat"></i></button>
							</div>
						</form>
					</div>
					<div class="col text-end">
						<button type="button" hidden="hidden" class="btn btn-light bm" onclick="location.href='${pageContext.request.contextPath}/dep_notice/write.do';">글올리기</button>
					</div>
				</div>	
		...
		<a href='${pageContext.request.contextPath}/dep_notice/write.do' class="float"><i class="fa fa-plus my-float"></i></a>
	</div>
</main>
