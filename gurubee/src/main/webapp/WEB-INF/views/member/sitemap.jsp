...
<ul>
   ...
   <li><a href="${pageContext.request.contextPath}/edoc/list_resp.do">결재문서 리스트 수신함</a></li>
   <li><a href="${pageContext.request.contextPath}/edoc/list_req.do">결재문서 리스트 발신함</a></li>
